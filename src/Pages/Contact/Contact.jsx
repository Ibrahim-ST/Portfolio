        ...
        <div className="sm:flex mt-5 ">
          <div className="sm:w-2/5 flex flex-col  justify-center px-10 lg:px-0">
            <h3 data-aos="zoom-out-right">
              ...
              <br />{" "}
              <span className="text-3xl">Tell me about your project.</span>{" "}
            </h3>
            ...
            <div data-aos="zoom-out-right" className="my-8">
              ...
              <div data-aos="zoom-out-right" className="flex gap-8 mt-4 ">
            ...
            <div className="w-full px-10">
              <form ref={form} onSubmit={sendEmail}>
                ...
                <div data-aos="zoom-out-left" className="text-center">
                  <input
                    className="btn   bg-slate-100 border-0 border-b-4 border-l-4 border-[#ff5478] mb-4 mt-2 hover:border-4 hover:border-[#ff5478] transform transition-all duration-100"
                    type="submit"
                    value="Send Message"
                  />
                </div>
